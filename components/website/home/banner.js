export default function Banner() {
    return (
        <section className="banner">
            ...
            <div className="row">
                <div className="col-md-6"> <span><img src="../images/women1-min.png" className="img-fluid" alt=""/></span> </div>
                <div className="col-md-6 pl-0">
                <div className="banner_text">
                    <h4>Your Academic Search Engine</h4>
                    <h1> Access step-wise solutions to over 50 million textbooks</h1>
                    <form>
                        <input type="text" placeholder="Search ISBN, textbook name or homework..." className="form-control"/>
