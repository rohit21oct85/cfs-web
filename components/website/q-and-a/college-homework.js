export default function CollegeHomework(){
    return(
            ...
            <div className="row clearfix1">
               ...
               <div className="col-md-6 float-left">
                  <div className="Text_title2 text_tb_center2 pb-3">
                     <h4 className="pb-2">College Homework  Q and A</h4>
                     <h2>Add College Homework  Q and A As fast  <span className="d_b">as in 30 Seconds</span></h2>
                     ...
                     <div className="btn1">
                        <a href="#">Add College Textbook</a>
                        <small className="text-black">* Add Unlimited College Homework  Q and A and get instant access</small>
                     </div>
                  </div>
               </div>
            </div>
