                ...
                <div className="row">
                    ...
                    <div className="col-md-6 ml-auto">
                        <ul className="faq-list">
                            <li>
                                <a data-toggle="collapse" className="collapsed" href="#faq1" onClick={()=>{openCollapse('faq1')}}>What are CrazyForStudy step-by-step Shuler: Bioprocess Engineering_c3 (3rd Edition) (Prentice Hall International Series in the Physical and Chemical Engineering Sciences) 3rd Edition Solutions Manuals? <i className="fa fa-arrow-up"></i></a>
                            ...
                            <li>
                                <a data-toggle="collapse" href="#faq2" className="collapsed" onClick={()=>{openCollapse('faq2')}}>Why is CrazyForStudy better than downloaded Shuler: Bioprocess Engineering_c3 (3rd Edition) (Prentice Hall International Series in the Physical and Chemical Engineering Sciences) 3rd Edition PDF solution manuals? <i className="fa fa-arrow-up"></i></a>
                            ...
                            <li>
                                <a data-toggle="collapse" href="#faq3" className="collapsed" onClick={()=>{openCollapse('faq3')}}> How is CrazyForStudy better than a printed Shuler: Bioprocess Engineering_c3 (3rd Edition) (Prentice Hall International Series in the Physical and Chemical Engineering Sciences) 3rd Edition student solution manual from the bookstore? <i className="fa fa-arrow-up"></i></a>
                                <div id="faq3" className={"collapse" + (whichCollapse == 'faq3' ? 'show' : '' )} data-parent=".faq-list">
                            ...
                            <li>
                                <a data-toggle="collapse" href="#faq4" className="collapsed" onClick={()=>{openCollapse('faq4')}}>Can I get help with questions outside of textbook solution manuals? <i className="fa fa-arrow-up"></i></a>
                                <div id="faq4" className={"collapse" + (whichCollapse == 'faq4' ? 'show' : '' )} data-parent=".faq-list">
                            ...
                            <li data-aos="fade-up" data-aos-delay="500" className="aos-init aos-animate">
                                <a data-toggle="collapse" href="#faq5" className="collapsed" onClick={()=>{openCollapse('faq5')}}>   How do I view solution manuals on my smartphone? <i className="fa fa-arrow-up"></i></a>
