        ...
        <section className="section font_sz text_justify pt-5 pb-4">
                ...
                <div className="row"> 
                    <div className="col-md-3 text-center">
                        <div className="prduct_details_img">
                            <ul>
                                <li><span><BookImage isbn={props.bookData.ISBN13}/></span></li>
            ...
            <div className="col-md-8 ml-auto pd_b_left">
                <div className="prduct_details_text">
                    <h3>{props.bookData.BookName} ({props.bookData.sub_subject_name}) </h3>
                        <p><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i></p>
                            ...
                            <ul className="books_wtext">
                                <li className="pl-0 border-left-0"><img src="/images/book1.jpg" className="img-fluid" alt=""/> Edition: <span>{props.bookData.Edition},</span></li>
                                <li><img src="/images/book2.jpg" className="img-fluid" alt=""/> Author: <span>{props.bookData.Author1},</span></li>
                                <li><img src="/images/book3.jpg" className="img-fluid" alt=""/> ISBN: <span>{props.bookData.ISBN13}</span></li>
                            </ul>
